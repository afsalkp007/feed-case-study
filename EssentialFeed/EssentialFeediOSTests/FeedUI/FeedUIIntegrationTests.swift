...
final class FeedUIIntegrationTests: XCTestCase {
  ...
  func test_errorView_rendersErrorOnFeedError() {
    let (sut, loader) = makeSUT()

    sut.simulateAppearance()
    XCTAssertNil(sut.errorMessage)

    loader.completeFeedLoadinWithError()
  ...
  func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
    ...
    loader.completeFeedLoadinWithError(at: 1)
  ...
  func test_loadFeedCompletion_doesNotAlterCurrentRenderingStateOnError() {
    ...
    sut.simulateUserInitiatedFeedReload()
    loader.completeFeedLoadinWithError(at: 0)
    assertThat(sut, isRendering: [image0])
  }
  ...
  func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
    ...
    sut.simulateAppearance()
    loader.completeFeedLoading(with: [image0, image1])
    XCTAssertEqual(loader.cancelledImageURLs, [], "Expected no cacnelled image URL requests until image is not visible")
  ...
  func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
    ...
    XCTAssertEqual(view?.isShowingRetryAction, true, "Expected retry action once image loading completes with inavlid image data")
  }
